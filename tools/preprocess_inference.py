...
parser.add_argument('--image_base_dir', type=str, default= "../data/example_images", help='The base directory of the images to be preprocessed')
...
parser.add_argument('--n_procs', type=int, default=4, help='Number of parallel processes to fit in a single GPU.')
